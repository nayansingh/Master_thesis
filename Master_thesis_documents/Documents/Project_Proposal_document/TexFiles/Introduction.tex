...
\pagebreak
 ...
 \includepdf[pages={1}]{./TeX_files/Project_Plan}
 }	
 \end{figure}
...
\pagebreak
 ...
 \begin{figure}[htp] \centering{
  \includepdf[pages={2}]{./TeX_files/Project_Plan}
  }	
 \end{figure}
...
\pagebreak
 ...
 \begin{figure}[htp] \centering{
  \includepdf[pages={3}]{./TeX_files/Project_Plan}
  }	
 \end{figure}
 
\pagebreak 
  \begin{figure}[htp] \centering{
   \includepdf[pages={4}]{./TeX_files/Project_Plan}
   }	
  \end{figure}
